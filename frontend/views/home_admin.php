...
<div id="container">
	<div id="userView">
        ...
        <br />
        <h3>Modify Patient Name</h3><br />
        <form action="" method="POST">
        <table class="tab">
            <tr>
            <td><h4>Current First Name:</h4><input type="text" maxlength="30" name="patFirstNameCurrent" /></td>
            <td><h4>Current Last Name:</h4><input type="text" maxlength="30" name="patLastNameCurrent" /></td>
			</tr>
            <tr>
            <td><h4>New First Name:    </h4><input type="text" maxlength="30" name="patFirstNameNew" /></td>
            <td><h4>New Last Name:    </h4><input type="text" maxlength="30" name="patLastNameNew" /></td>
            </tr> </table>
